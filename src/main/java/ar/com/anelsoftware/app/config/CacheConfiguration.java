package ar.com.anelsoftware.app.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Queen");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("Queen");
        ...
        config.getMapConfigs().put("ar.com.anelsoftware.app.domain.*", initializeDomainMapConfig(jHipsterProperties));
