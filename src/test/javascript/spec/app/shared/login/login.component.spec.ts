...
import { QueenLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: QueenLoginModalComponent;
        let fixture: ComponentFixture<QueenLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [QueenLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(QueenLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(QueenLoginModalComponent);
